        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 d-none d-lg-block" ><img src="\customAuth\css\image\pic1.jpg" width="480" height="725"/></div> 
                    <div class="col-lg-7">
                        <div class="p-5">
            ...
            @enderror                         
             ...
             <div class="form-group row">
                ...
                <label for="phoneNo" class="col-md-4 col-form-label text-md-right">{{ __('phoneNo') }}</label>                  
                         <div class="col-md-6">                    
                          <input id="phoneNo" type="phoneNO" class="form-control @error('phoneNo') is-invalid @enderror" name="phoneNo" value="{{ old('phoneNo') }}" required autocomplete="phoneNo">
                           @error('phoneNo')
                           <span class="invalid-feedback" role="alert">         
                           <strong>{{ $message }}</strong>                             
                            </span>                       
