...
<form class="order-details action-buttons-fixed" method="post">
										...
										<div class="form-row">
											<div class="form-group col mb-3">
												...
												<select class="form-control form-control-modern" name="orderCustomer" required data-plugin-selectTwo>
													<option value="21" selected>Ham</option>
													<option value="33">Ali</option>
													<option value="55">Umer</option>
													<option value="60">Bilal</option>
												</select>
											</div>
										</div>
									</div>
									...
									<div class="card-body">
										<div class="row">
											<div class="col-xl-auto mr-xl-5 pr-xl-5 mb-4 mb-xl-0">
												...
												<a href="mailto:johndoe@domain.com">ham@domain.com</a>
											...
											<div class="col-xl-auto pl-xl-5">
												<h3 class="font-weight-bold text-color-dark text-4 line-height-1 mt-0 mb-3">Agent</h3>
												<ul class="list list-unstyled list-item-bottom-space-0">
													<li>Street Name Example</li>
													<li>1234</li>
													<li>Detroit</li>
						...
						<div class="row">
							<div class="col">
								...
								<div class="card card-modern">
									<div class="card-header">
										<h2 class="card-title">Property Products</h2>
									</div>
									<div class="card-body">
