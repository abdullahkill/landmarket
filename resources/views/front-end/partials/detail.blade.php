        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-4 hidden-xs">
                ...
                <div class="hot-properties hidden-xs">
                    ...
                    <div class="row">
                        @if($i <=4) @foreach($show as $images) @if($property->id== $images->property_id)
                            ...
                            <div class="col-lg-4 col-sm-5">
                                <img src="{{asset('storage/property_image/'.$pro_image)}}"
                                    class="img-responsive img-circle" alt="properties" />
                            </div>
                            <div class="col-lg-8 col-sm-7">
                                <h5><a href="{{url('/Detail',$property->id)}}">{{$property->PropertyTittle}}</a></h5>
                                <p class="price">$ {{$property->Propertyprice}}</p>
                            </div>
                        ...
                        <div class="property-images">
                            ...
                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <div class="item active slide_img">
                                        <img src="{{asset('storage/property_image/'.$datas->image)}}"
                                            style="height:300px!important;" class="properties w-100" alt="properties" />
                                    </div>
                                    @else
                        ...
                        <div class="col-lg-12  col-sm-6">
                            ...
                            <div class="listing-detail">
                                <span data-toggle="tooltip" data-placement="bottom"
                                    data-original-title="Bed Room">5</span>
                                <span data-toggle="tooltip" data-placement="bottom"
                                    data-original-title="Living Room">2</span> <span data-toggle="tooltip"
                                    data-placement="bottom" data-original-title="Parking">2</span> <span
